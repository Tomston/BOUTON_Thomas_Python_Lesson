class data():
    ...
    def __init__(self):
        self.Nasdaq_date = None
        self.Nasdaq_performance = None
        self.SP500_date = None
        self.SP500_performance = None
        self.CAC40_date = None
        self.CAC40_performance = None
        self.Eurostoxx50_date = None
        self.Eurostoxx50_performance = None
        self.MSCIWORLD_date = None
        self.MSCIWORLD_performance = None
